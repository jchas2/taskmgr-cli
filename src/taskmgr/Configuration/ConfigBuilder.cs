...
// {
//     private readonly string StatsCols = string.Join(", ", Enum.GetNames<Statistics>());
//
...
//
//     private ConfigSection BuildConfigSection(string name)
//     {
...
//     }
//     
//     private ConfigSection GetConfigSection(string name, Config config) =>
...
//
//     private void MapColours(ConfigSection section, string[,] colourMap)
//     {
...
//     }
//     
//     public void Merge(Config withConfig)
//     {
